...
public class StudentAIService : IStudentAIService
{
    ...
    private readonly IStudentAIResponseFormatter _formatter;// fomate
    private readonly ILessonRankingService _lessonRankingService; // AI rangking 
        ...
        switch (intent)
        {
            ...
            case StudentIntent.AcademicInformation:
                ...
                return new StudentAIResponseDto
                {
                    ...
                    Source = "Student Academic System",
                    Confidence = 0.70m,
                    CreatedAt = DateTime.UtcNow
                };
